/*
 * func-name: _task_suspend2
 * func-address: 0x130f0
...
kern_return_t __cdecl task_suspend2(task_t target_task, task_suspension_token_t *suspend_token)
{
  ...
  task_suspension_token_t v8; // [xsp+1Ch] [xbp-24h]
  ...
  if ( v6.msgh_id != 71 )
  {
    if ( v6.msgh_id == 3536 )
    {
      if ( (v6.msgh_bits & 0x80000000) != 0 )
      {
        ...
        {
          v4 = HIBYTE(v10) == 0 && (v10 & 0xFF0000) == 1179648 ? 0 : -300;
          if ( HIBYTE(v10) == 0 && (v10 & 0xFF0000) == 1179648 )
          {
            v4 = 0;
            *suspend_token = v8;
          }
