/*
 * func-name: __kernelrpc_mach_vm_deallocate
 * func-address: 0xd7bc
...
__int64 __fastcall _kernelrpc_mach_vm_deallocate(mach_port_t a1, __int64 a2, __int64 a3)
{
  __int64 v3; // x0
  __int64 v4; // x19
  ...
  v6.msgh_id = 4801;
  v3 = mach_msg(&v6, 3, 0x30u, 0x2Cu, v6.msgh_local_port, 0, 0);
  v4 = v3;
