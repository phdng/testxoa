/*
 * func-name: __kernelrpc_mach_port_dnrequest_info
 * func-address: 0xcc40
...
__int64 __fastcall _kernelrpc_mach_port_dnrequest_info(mach_port_t a1, unsigned int a2, _DWORD *a3, _DWORD *a4)
{
  __int64 v6; // x0
  __int64 v7; // x21
  __int64 v8; // x8
  ...
  v10.msgh_id = 3224;
  v6 = mach_msg(&v10, 3, 0x24u, 0x34u, v10.msgh_local_port, 0, 0);
  v7 = v6;
