/*
 * func-name: __kernelrpc_mach_port_get_context
 * func-address: 0x4268
...
__int64 __fastcall _kernelrpc_mach_port_get_context(mach_port_t a1, unsigned int a2, _QWORD *a3)
{
  __int64 v4; // x0
  __int64 v5; // x20
  __int64 v6; // x8
  ...
  v8.msgh_id = 3228;
  v4 = mach_msg(&v8, 3, 0x24u, 0x34u, v8.msgh_local_port, 0, 0);
  v5 = v4;
