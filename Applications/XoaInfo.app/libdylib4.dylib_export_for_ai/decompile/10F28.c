/*
 * func-name: _task_set_info
 * func-address: 0x10f28
 * export-type: decompile
 * callers: none
 * callees: 0x1ac4, 0x1f38, 0x1f6c, 0x3598, 0x5694
 */

kern_return_t __cdecl task_set_info(
        task_t target_task,
        ...
        mach_msg_type_number_t task_info_inCnt)
{
  ...
  mach_msg_header_t v10; // [xsp+8h] [xbp-128h] BYREF
  NDR_record_t v11; // [xsp+20h] [xbp-110h]
  task_flavor_t v12; // [xsp+28h] [xbp-108h]
  mach_msg_type_number_t v13; // [xsp+2Ch] [xbp-104h]
  __int64 v14; // [xsp+30h] [xbp-100h] BYREF

  v11 = NDR_record;
  v12 = flavor;
  v6 = -307;
  if ( task_info_inCnt > 0x34 )
    return v6;
  v7 = 4 * task_info_inCnt;
  memcpy(&v14, task_info_in, 4 * task_info_inCnt);
  v13 = task_info_inCnt;
  v10.msgh_bits = 5395;
