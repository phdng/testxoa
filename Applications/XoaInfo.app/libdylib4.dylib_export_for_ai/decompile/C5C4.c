/*
 * func-name: __kernelrpc_mach_port_allocate_qos
 * func-address: 0xc5c4
...
__int64 __fastcall _kernelrpc_mach_port_allocate_qos(mach_port_t a1, unsigned int a2, __int64 *a3, _DWORD *a4)
{
  __int64 v6; // x0
  __int64 v7; // x21
  __int64 v8; // x8
  ...
  v10.msgh_id = 3219;
  v6 = mach_msg(&v10, 3, 0x2Cu, 0x38u, v10.msgh_local_port, 0, 0);
  v7 = v6;
