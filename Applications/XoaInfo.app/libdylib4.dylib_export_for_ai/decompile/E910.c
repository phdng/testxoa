...
kern_return_t __cdecl mach_vm_region(
        ...
        mach_port_t *object_name)
{
  ...
  mach_vm_address_t v21; // [xsp+28h] [xbp-98h]
  vm_region_flavor_t v22; // [xsp+30h] [xbp-90h]
  mach_msg_type_number_t v23; // [xsp+34h] [xbp-8Ch]
  mach_vm_address_t v24; // [xsp+38h] [xbp-88h]
  mach_vm_size_t v25; // [xsp+40h] [xbp-80h]
