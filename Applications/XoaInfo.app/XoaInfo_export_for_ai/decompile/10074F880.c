/*
 * func-name: -[SlideNavigationController righttMenuSelected:]
 * func-address: 0x10074f880
 * export-type: decompile
 * callers: none
 * callees: 0x10074dbc0, 0x100798e78
 */

void __cdecl -[SlideNavigationController righttMenuSelected:](SlideNavigationController *self, SEL a2, id a3)
{
  const char *v4; // x1
