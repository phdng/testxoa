/*
 * func-name: -[UIView addPreviousNextRightOnKeyboardWithTarget:rightButtonImage:previousAction:nextAction:rightButtonAction:titleText:]
 * func-address: 0x10078547c
 * export-type: decompile
 * callers: 0x100785368, 0x100785378
 * callees: 0x100782ea4, 0x100782ff4, 0x1007830a8, 0x10078360c, 0x100798dac, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

void __cdecl -[UIView addPreviousNextRightOnKeyboardWithTarget:rightButtonImage:previousAction:nextAction:rightButtonAction:titleText:](
        UIView *self,
        SEL a2,
        id a3,
        id a4,
        ...
        id a8)
{
  ...
  objc_release(v19);
  v21 = -[IQBarButtonItemConfiguration initWithImage:action:](
