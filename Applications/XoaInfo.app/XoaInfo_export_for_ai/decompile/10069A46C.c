/*
 * func-name: sub_10069A46C
 * func-address: 0x10069a46c
 * export-type: decompile
 * callers: 0x10069a104
 * callees: 0x100798e60, 0x100798e78, 0x100798e90, 0x100798ec0
 */

void __fastcall sub_10069A46C(__int64 a1)
{
  id *v2; // x19
  id WeakRetained; // x21
...
LABEL_9:
        ...
        v9 = objc_retainAutoreleasedReturnValue(objc_msgSend(v8, "labelSize"));
        ...
        v12 = objc_retainAutoreleasedReturnValue(objc_msgSend(v11, "labelSize"));
