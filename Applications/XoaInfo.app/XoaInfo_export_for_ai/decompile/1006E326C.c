/*
 * func-name: -[u8sEaswy linkItemAtPath:toPath:error:]
 * func-address: 0x1006e326c
 * export-type: decompile
 * callers: 0x1006e326c
 * callees: 0x1006e1968, 0x1006e326c, 0x1006e4414, 0x10079892c, 0x100798db8, 0x100798e78, 0x100798e84, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

bool __cdecl -[u8sEaswy linkItemAtPath:toPath:error:](u8sEaswy *self, SEL a2, id a3, id a4, id *a5)
{
  id v8; // x19
  id v9; // x20
  ...
  if ( !+[u8sEaswy y4ayWsb7](&OBJC_CLASS___u8sEaswy, "y4ayWsb7") )
  {
    ...
    v11 = objc_retainAutoreleasedReturnValue(
            +[NSDictionary dictionaryWithObjects:forKeys:count:](
              ...
              v24,
              2));
    v12 = objc_retainAutoreleasedReturnValue(sub_1006E1968(CFSTR("linkItemAtPath"), v11));
    objc_release(v11);
    if ( v12 )
    {
...
LABEL_11:
  ...
  v10 = -[u8sEaswy linkItemAtPath:toPath:error:](&v19, "linkItemAtPath:toPath:error:", v8, v9, a5);
LABEL_12:
  objc_release(v9);
  objc_release(v8);
  return v10;
