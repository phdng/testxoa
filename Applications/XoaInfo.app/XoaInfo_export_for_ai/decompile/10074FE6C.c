/*
 * func-name: -[SlideNavigationController maxXForDragging]
 * func-address: 0x10074fe6c
 * export-type: decompile
 * callers: 0x10074f9d8
 * callees: 0x10074e914, 0x10074f4a4, 0x10074f7d8, 0x100798e78, 0x100798e90, 0x100798ec0
 */

signed __int64 __cdecl -[SlideNavigationController maxXForDragging](SlideNavigationController *self, SEL a2)
{
  id v3; // x20
  unsigned int v4; // w21
  double v5; // d0
