/*
 * func-name: -[NSData v4WpQp1f:]
 * func-address: 0x1006e08d0
 * export-type: decompile
 * callers: none
 * callees: 0x100798ddc, 0x100798e78, 0x100798ea8, 0x100798ec0
 */

id __cdecl -[NSData v4WpQp1f:](NSData *self, SEL a2, unsigned int a3)
{
  NSData *v4; // x22
  char *v5; // x20
  ...
  if ( v7 >= 1 )
  {
    ...
    do
    {
      ...
      if ( v11 == 1 )
        ...
        v15 = v14;
      -[NSMutableString appendFormat:](v6, "appendFormat:", CFSTR("%c"), aAbcdefghijklmn[(unsigned __int64)v23 >> 2]);
      v16 = 1;
      do
        -[NSMutableString appendFormat:](
          ...
          "appendFormat:",
          CFSTR("%c"),
          aAbcdefghijklmn[(unsigned __int8)v22[(__int16)v16++]]);
