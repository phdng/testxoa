/*
 * func-name: sub_100417414
 * func-address: 0x100417414
 * export-type: decompile
 * callers: 0x100416fe0, 0x100416ff4
 * callees: 0x10056b9b8, 0x100798a88, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0, 0x1007991b4
 */

__int64 sub_100417414()
{
  __int64 v0; // x23
  void **v1; // x24
  __int64 v2; // x25
  ...
  *v35 = 0;
  ...
  v36 = (__int64 (*)(void))nullsub_25(off_10094C370[*(unsigned int *)(v3 - 152)]);
  return v36();
}
