/*
 * func-name: -[IQKeyboardReturnKeyHandler textFieldShouldClear:]
 * func-address: 0x1007877c8
 * export-type: decompile
 * callers: none
 * callees: 0x100786410, 0x100788740, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

bool __cdecl -[IQKeyboardReturnKeyHandler textFieldShouldClear:](IQKeyboardReturnKeyHandler *self, SEL a2, id a3)
{
  id v4; // x19
  ...
  if ( (unsigned int)-[UITextFieldDelegate respondsToSelector:](v5, "respondsToSelector:", "textFieldShouldClear:") )
    v7 = (unsigned __int8)-[UITextFieldDelegate textFieldShouldClear:](v5, "textFieldShouldClear:", v4);
  else
    v7 = 1;
  objc_release(v5);
  objc_release(v4);
