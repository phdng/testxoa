...
void __fastcall sub_100694ACC(__int64 a1)
{
  ...
  __int64 (__fastcall *v18)(__int64, __int64); // [xsp+48h] [xbp-38h]
  void (__fastcall *v19)(__int64); // [xsp+50h] [xbp-30h]
  ...
  objc_msgSend(v7, "setText:", CFSTR("Hook Apps..."));
  objc_release(v7);
