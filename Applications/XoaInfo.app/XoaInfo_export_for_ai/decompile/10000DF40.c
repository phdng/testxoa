/*
 * func-name: -[IQKeyboardManager nextAction:]
 * func-address: 0x10000df40
 * export-type: decompile
 * callers: none
 * callees: 0x10000c860, 0x10000ca28, 0x100798e60, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

void __cdecl -[IQKeyboardManager nextAction:](IQKeyboardManager *self, SEL a2, id a3)
{
  id v4; // x19
  UIDevice *v5; // x21
  id WeakRetained; // x23
  ...
  if ( -[IQKeyboardManager canGoNext](self, "canGoNext") )
  {
    WeakRetained = objc_loadWeakRetained((id *)&self->_textFieldView);
    v7 = -[IQKeyboardManager goNext](self, "goNext");
    ...
    if ( v10 )
    {
      ...
      v13 = objc_retainAutoreleasedReturnValue(objc_msgSend(v12, "nextBarButton"));
