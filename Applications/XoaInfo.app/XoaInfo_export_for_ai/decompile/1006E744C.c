/*
 * func-name: sub_1006E744C
 * func-address: 0x1006e744c
 * export-type: decompile
 * callers: 0x1006e5bec, 0x1006e63a8, 0x1006e6afc
 * callees: none
 */

__int64 __fastcall sub_1006E744C(__int64 a1, __int64 a2, unsigned __int64 *a3)
{
