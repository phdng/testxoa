/*
 * func-name: -[IQKeyboardReturnKeyHandler textViewDidChangeSelection:]
 * func-address: 0x100787f30
 * export-type: decompile
 * callers: none
 * callees: 0x100786410, 0x100788740, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

void __cdecl -[IQKeyboardReturnKeyHandler textViewDidChangeSelection:](IQKeyboardReturnKeyHandler *self, SEL a2, id a3)
{
  id v4; // x19
  ...
  if ( (unsigned int)-[UITextFieldDelegate respondsToSelector:](
    ...
    -[UITextFieldDelegate textViewDidChangeSelection:](v5, "textViewDidChangeSelection:", v4);
  objc_release(v5);
  objc_release(v4);
}
