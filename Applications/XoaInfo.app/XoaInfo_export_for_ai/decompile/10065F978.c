/*
 * func-name: sub_10065F978
 * func-address: 0x10065f978
...
void sub_10065F978()
{
  ...
  *(_QWORD *)(v0 + 264) = objc_retainAutoreleasedReturnValue(
                            objc_msgSend(
                              *(id *)(v1 - 128),
                              *(SEL *)(v1 - 136),
  ...
  *(_BYTE *)(v0 + 263) = (unsigned __int8)objc_msgSend(
                                            *(id *)(v0 + 264),
                                            *(SEL *)(v1 - 208),
                                            objc_msgSend(&OBJC_CLASS___NSNumber, *(SEL *)(v1 - 200)));
  JUMPOUT(0x10065FA10LL);
}
