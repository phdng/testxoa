/*
 * func-name: -[WYPopoverTheme outerStrokeColor]
 * func-address: 0x100767258
 * export-type: decompile
 * callers: none
 * callees: 0x100766128, 0x100767368, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

UIColor *__cdecl -[WYPopoverTheme outerStrokeColor](WYPopoverTheme *self, SEL a2)
{
  UIColor *v3; // x19
  UIColor *v4; // x20
  double v5; // d0
  ...
  v3 = objc_retain(self->outerStrokeColor);
  if ( !v3 )
  {
