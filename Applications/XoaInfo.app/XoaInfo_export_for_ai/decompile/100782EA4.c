/*
 * func-name: -[IQBarButtonItemConfiguration initWithImage:action:]
 * func-address: 0x100782ea4
 * export-type: decompile
 * callers: 0x10000cd34
 * callees: 0x100798e84, 0x100798e90, 0x100798e9c, 0x100798f08
 */

IQBarButtonItemConfiguration *__cdecl -[IQBarButtonItemConfiguration initWithImage:action:](
