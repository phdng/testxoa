/*
 * func-name: -[UIView addRightButtonOnKeyboardWithImage:target:action:titleText:]
 * func-address: 0x100784ae0
 * export-type: decompile
 * callers: 0x1007849ec, 0x1007849fc
 * callees: 0x100782ea4, 0x10078360c, 0x100798dac, 0x100798e78, 0x100798e90, 0x100798e9c
 */

void __cdecl -[UIView addRightButtonOnKeyboardWithImage:target:action:titleText:](
        UIView *self,
        SEL a2,
        id a3,
        id a4,
        ...
        id a6)
{
  ...
  v11 = objc_retain(a4);
  v12 = objc_retain(a3);
  v13 = -[IQBarButtonItemConfiguration initWithImage:action:](
