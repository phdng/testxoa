/*
 * func-name: -[IQKeyboardManager doneAction:]
 * func-address: 0x10000e174
 * export-type: decompile
 * callers: none
 * callees: 0x10000c704, 0x100798e60, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

void __cdecl -[IQKeyboardManager doneAction:](IQKeyboardManager *self, SEL a2, id a3)
{
  id v4; // x19
  UIDevice *v5; // x21
  id WeakRetained; // x23
  ...
  v7 = -[IQKeyboardManager resignFirstResponder](self, "resignFirstResponder");
  ...
  if ( v10 )
  {
    ...
    v13 = objc_retainAutoreleasedReturnValue(objc_msgSend(v12, "doneBarButton"));
