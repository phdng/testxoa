/*
 * func-name: sub_100296E84
 * func-address: 0x100296e84
 * export-type: decompile
 * callers: none
 * callees: 0x100798e78, 0x100798e90, 0x100798ec0
 */

__int64 sub_100296E84()
{
  __int64 v0; // x19
  __int64 v1; // x29
  unsigned int v2; // w22
  ...
  v2 = (-791671530 * (dword_10088A548 + dword_10088A54C)) | 0x16193E06;
  v3 = objc_retainAutoreleasedReturnValue(objc_msgSend(&OBJC_CLASS___NSFileManager, *(SEL *)(v1 - 160)));
