/*
 * func-name: -[IQKeyboardReturnKeyHandler textField:editMenuForCharactersInRange:suggestedActions:]
 * func-address: 0x1007874dc
 * export-type: decompile
 * callers: none
 * callees: 0x100786410, 0x100788740, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

id __cdecl -[IQKeyboardReturnKeyHandler textField:editMenuForCharactersInRange:suggestedActions:](
        ...
        id a5)
{
  ...
  if ( (unsigned int)-[UITextFieldDelegate respondsToSelector:](
    ...
    v13 = objc_retainAutoreleasedReturnValue(
            -[UITextFieldDelegate textField:editMenuForCharactersInRange:suggestedActions:](
              v11,
              "textField:editMenuForCharactersInRange:suggestedActions:",
              v9,
              location,
