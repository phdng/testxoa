/*
 * func-name: -[IQKeyboardReturnKeyHandler textField:willDismissEditMenuWithAnimator:]
 * func-address: 0x1007876e0
 * export-type: decompile
 * callers: none
 * callees: 0x100786410, 0x100788740, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

void __cdecl -[IQKeyboardReturnKeyHandler textField:willDismissEditMenuWithAnimator:](
        ...
        id a4)
{
  ...
  if ( (unsigned int)-[UITextFieldDelegate respondsToSelector:](
    ...
    -[UITextFieldDelegate textField:willDismissEditMenuWithAnimator:](
      v8,
      "textField:willDismissEditMenuWithAnimator:",
      v6,
      v7);
