...
__int64 sub_100047EEC()
{
  ...
  *(_QWORD *)v0 = 1303747859 * ((dword_1007FC9C8 / (unsigned int)dword_1007FC9CC) ^ 0x71EFEA96) / 0xBA6C6139uLL;
  ...
  *(_QWORD *)(v11 + 32) = *(_QWORD *)(v0 + 2128);
  ...
  objc_release(v14);
  if ( (unsigned int)*(_QWORD *)v0 <= 0xE758AA3C )
    v16 = -459160668;
  else
    v16 = 1311438638;
  **(_DWORD **)(v0 + 16) = v16;
  return sub_10005ECD0(v15);
}
