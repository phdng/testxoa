/*
 * func-name: -[IQKeyboardReturnKeyHandler textView:shouldInteractWithURL:inRange:interaction:]
 * func-address: 0x100787ffc
 * export-type: decompile
 * callers: none
 * callees: 0x100786410, 0x100788740, 0x100798e78, 0x100798e90, 0x100798e9c, 0x100798ec0
 */

bool __cdecl -[IQKeyboardReturnKeyHandler textView:shouldInteractWithURL:inRange:interaction:](
        ...
        signed __int64 a6)
{
  ...
  if ( (unsigned int)-[UITextFieldDelegate respondsToSelector:](
    ...
    v15 = (unsigned __int8)-[UITextFieldDelegate textView:shouldInteractWithURL:inRange:interaction:](
                             v13,
                             "textView:shouldInteractWithURL:inRange:interaction:",
                             v11,
                             v12,
