        ...
        __int64 a19)
{
  ...
  v26[1] = 3254779904LL;
  v26[2] = __48__GCDAsyncProxySocket_socketDidCloseReadStream___block_invoke;
  v26[3] = &__block_descriptor_40_e8_32s_e5_v8__0l;
  v27 = v19;
  dispatch_async(v20, v26);
  objc_release(v20);
  return nullsub_5(off_790D8, v21, v22, v23, v24);
}
