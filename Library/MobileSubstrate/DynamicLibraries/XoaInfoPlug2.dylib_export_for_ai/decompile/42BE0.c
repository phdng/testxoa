/*
 * func-name: -[GCDAsyncSocket connectToAddress:viaInterface:withTimeout:error:]
 * func-address: 0x42be0
 * export-type: decompile
 * callers: 0x42bb4, 0x42bcc
 * callees: 0x51670, 0x517a8, 0x51880, 0x51af0, 0x51b08, 0x51b14, 0x51b20, 0x51b44
 */

bool __cdecl -[GCDAsyncSocket connectToAddress:viaInterface:withTimeout:error:](
        GCDAsyncSocket *self,
        SEL a2,
        id a3,
        id a4,
        ...
        id *a6)
{
  ...
  GCDAsyncSocket *v22; // [xsp+28h] [xbp-D8h]
  ...
  v20[1] = 3254779904LL;
  v20[2] = __66__GCDAsyncSocket_connectToAddress_viaInterface_withTimeout_error___block_invoke;
