/*
 * func-name: -[GCDWebServerErrorResponse initWithServerError:underlyingError:message:]
 * func-address: 0x5d0c
...
GCDWebServerErrorResponse *__cdecl -[GCDWebServerErrorResponse initWithServerError:underlyingError:message:](
