/*
 * func-name: -[GCDAsyncSocket isIPv4]
 * func-address: 0x47500
 * export-type: decompile
 * callers: none
 * callees: 0x51670, 0x517a8, 0x51880
 */

bool __cdecl -[GCDAsyncSocket isIPv4](GCDAsyncSocket *self, SEL a2)
{
  bool v3; // w19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __24__GCDAsyncSocket_isIPv4__block_invoke;
