/*
 * func-name: -[GCDAsyncSocket setDelegateQueue:synchronously:]
 * func-address: 0x3fab4
 * export-type: decompile
 * callers: none
 * callees: 0x5176c, 0x517a8, 0x51880, 0x51b08, 0x51b14, 0x51b44
 */

void __cdecl -[GCDAsyncSocket setDelegateQueue:synchronously:](GCDAsyncSocket *self, SEL a2, id a3, bool a4)
{
  _BOOL4 v4; // w20
  id v6; // x19
  _QWORD *v7; // x22
  ...
  v9[1] = 3254779904LL;
  v9[2] = __49__GCDAsyncSocket_setDelegateQueue_synchronously___block_invoke;
