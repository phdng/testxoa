/*
 * func-name: +[GCDAsyncSocket lookupHost:port:error:]
 * func-address: 0x4edd8
 * export-type: decompile
 * callers: none
 * callees: 0x516ac, 0x5191c, 0x51958, 0x51af0, 0x51b08, 0x51b14, 0x51b20, 0x51b38
 */

id __cdecl +[GCDAsyncSocket lookupHost:port:error:](id a1, SEL a2, id a3, unsigned __int16 a4, id *a5)
{
  unsigned int v6; // w24
  id v8; // x20
  NSData *v9; // x22
...
LABEL_32:
      ...
      v18 = 4;
LABEL_8:
      v12 = objc_retainAutoreleasedReturnValue(objc_msgSend(a1, "gaiError:", v18));
      goto LABEL_32;
    }
    v28 = __rev16(v6);
    while ( 1 )
