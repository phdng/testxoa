/*
 * func-name: ___70-[GCDAsyncSocket connectToHost:onPort:viaInterface:withTimeout:error:]_block_invoke
 * func-address: 0x42560
 * export-type: decompile
 * callers: 0x42350
 * callees: 0x5176c, 0x5179c, 0x51a6c, 0x51a78, 0x51a9c, 0x51aa8, 0x51ad8, 0x51af0, 0x51b08, 0x51b14, 0x51b38, 0x51b74
 */

void __fastcall __70__GCDAsyncSocket_connectToHost_onPort_viaInterface_withTimeout_error___block_invoke(__int64 a1)
{
  void *v2; // x19
  id v3; // x8
  void *v4; // x0
  ...
  v27 = *(id *)(v6 + 40);
  v7 = (unsigned int)objc_msgSend(v4, "preConnectWithInterface:error:", v5, &v27);
  ...
  if ( v7 )
  {
    *(_DWORD *)(*(_QWORD *)(a1 + 40) + 8LL) |= 1u;
    ...
    v18 = 3254779904LL;
    v19 = __70__GCDAsyncSocket_connectToHost_onPort_viaInterface_withTimeout_error___block_invoke_2;
    ...
    objc_msgSend(*(id *)(a1 + 40), "startConnectTimeout:", *(double *)(a1 + 72), v17, v18, v19, v20, v21);
