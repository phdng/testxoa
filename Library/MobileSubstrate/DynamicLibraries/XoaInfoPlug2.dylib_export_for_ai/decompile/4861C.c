/*
 * func-name: -[GCDAsyncSocket progressOfReadReturningTag:bytesDone:total:]
 * func-address: 0x4861c
 * export-type: decompile
 * callers: none
 * callees: 0x51670, 0x517a8, 0x51880, 0x51b08, 0x51b44
 */

float __cdecl -[GCDAsyncSocket progressOfReadReturningTag:bytesDone:total:](
        GCDAsyncSocket *self,
        SEL a2,
        signed __int64 *a3,
        unsigned __int64 *a4,
        unsigned __int64 *a5)
{
  ...
  v9[1] = 3254779904LL;
  v9[2] = __61__GCDAsyncSocket_progressOfReadReturningTag_bytesDone_total___block_invoke;
