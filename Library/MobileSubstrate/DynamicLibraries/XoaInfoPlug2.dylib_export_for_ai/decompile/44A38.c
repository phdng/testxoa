/*
 * func-name: -[GCDAsyncSocket didNotConnect:error:]
 * func-address: 0x44a38
 * export-type: decompile
 * callers: none
 * callees: 0x44d2c, 0x517a8, 0x51af0, 0x51b08, 0x51b14, 0x51b38
 */

void __cdecl -[GCDAsyncSocket didNotConnect:error:](GCDAsyncSocket *self, SEL a2, int a3, id a4)
{
  id v7; // x19
