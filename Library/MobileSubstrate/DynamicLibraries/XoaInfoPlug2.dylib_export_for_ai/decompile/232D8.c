/*
 * func-name: ___58-[GCDWebServerConnection _readBodyWithLength:initialData:]_block_invoke
 * func-address: 0x232d8
 * export-type: decompile
 * callers: 0x23064
 * callees: 0x33948, 0x51af0, 0x51b08, 0x51b14
 */

void __fastcall __58__GCDWebServerConnection__readBodyWithLength_initialData___block_invoke(__int64 a1)
{
  void *v2; // x0
  unsigned int v3; // w21
  int v4; // w2
