/*
 * func-name: -[GCDAsyncSocket connectedHost]
 * func-address: 0x463c8
 * export-type: decompile
 * callers: 0x442d0
 * callees: 0x46cb8, 0x51670, 0x517a8, 0x51880, 0x51af0, 0x51b08, 0x51b14, 0x51b38
 */

NSString *__cdecl -[GCDAsyncSocket connectedHost](GCDAsyncSocket *self, SEL a2)
{
  id v3; // x0
  ...
  if ( !dispatch_get_specific(self->IsOnSocketQueueOrTargetQueueKey) )
  {
    ...
    v7[1] = 3254779904LL;
    v7[2] = __31__GCDAsyncSocket_connectedHost__block_invoke;
  ...
  if ( self->socket4FD != -1 )
  {
    v3 = -[GCDAsyncSocket connectedHostFromSocket4:](self, "connectedHostFromSocket4:");
    return (NSString *)objc_autoreleaseReturnValue(objc_retainAutoreleasedReturnValue(v3));
  }
  if ( self->socket6FD != -1 )
  {
    v3 = -[GCDAsyncSocket connectedHostFromSocket6:](self, "connectedHostFromSocket6:");
    return (NSString *)objc_autoreleaseReturnValue(objc_retainAutoreleasedReturnValue(v3));
  }
