/*
 * func-name: -[GCDAsyncSocket userData]
 * func-address: 0x404b4
 * export-type: decompile
 * callers: none
 * callees: 0x51670, 0x517a8, 0x51880, 0x51b08, 0x51b14, 0x51b44
 */

id __cdecl -[GCDAsyncSocket userData](GCDAsyncSocket *self, SEL a2)
{
  _QWORD *v3; // x20
  id v4; // x19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __26__GCDAsyncSocket_userData__block_invoke;
