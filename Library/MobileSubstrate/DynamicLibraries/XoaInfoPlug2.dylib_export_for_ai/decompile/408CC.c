/*
 * func-name: ___47-[GCDAsyncSocket acceptOnInterface:port:error:]_block_invoke
 * func-address: 0x408cc
 * export-type: decompile
 * callers: 0x406b4
 * callees: 0x516a0, 0x516f4, 0x51724, 0x518e0, 0x519f4, 0x51af0, 0x51b08, 0x51b14, 0x51b20, 0x51b38, 0x51bf8, 0x51c04
 */

__int64 __fastcall __47__GCDAsyncSocket_acceptOnInterface_port_error___block_invoke(__int64 a1, int a2, id a3)
{
  id v5; // x19
  __int64 v6; // x0
  __int64 v7; // x20
