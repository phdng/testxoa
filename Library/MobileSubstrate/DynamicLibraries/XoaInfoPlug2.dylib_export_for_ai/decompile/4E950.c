/*
 * func-name: -[GCDAsyncSocket autoDisconnectOnClosedReadStream]
 * func-address: 0x4e950
 * export-type: decompile
 * callers: none
 * callees: 0x51670, 0x517a8, 0x51880
 */

bool __cdecl -[GCDAsyncSocket autoDisconnectOnClosedReadStream](GCDAsyncSocket *self, SEL a2)
{
  bool v3; // w19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __50__GCDAsyncSocket_autoDisconnectOnClosedReadStream__block_invoke;
