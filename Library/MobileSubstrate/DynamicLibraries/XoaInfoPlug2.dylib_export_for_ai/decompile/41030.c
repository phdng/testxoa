/*
 * func-name: ___47-[GCDAsyncSocket acceptOnInterface:port:error:]_block_invoke_2
 * func-address: 0x41030
 * export-type: decompile
 * callers: 0x40aec
 * callees: 0x51844, 0x51a78, 0x51ae4, 0x51af0, 0x51b08
 */

void __fastcall __47__GCDAsyncSocket_acceptOnInterface_port_error___block_invoke_2(__int64 a1)
{
  void *v2; // x19
  id WeakRetained; // x21
  uintptr_t data; // x22
