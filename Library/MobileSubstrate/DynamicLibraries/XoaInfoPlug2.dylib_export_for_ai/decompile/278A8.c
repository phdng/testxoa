/*
 * func-name: _GCDWebServerFormatRFC822
 * func-address: 0x278a8
 * export-type: decompile
 * callers: 0x229b8, 0x22b58
 * callees: 0x51670, 0x51880, 0x51b08, 0x51b14
 */

id __fastcall GCDWebServerFormatRFC822(void *a1)
{
  id v1; // x0
  NSObject *v2; // x19
  id v3; // x20
  ...
  __int64 (__fastcall *v12)(); // [xsp+48h] [xbp-28h]
  __int64 (__fastcall *v13)(); // [xsp+50h] [xbp-20h]
  ...
  v6[1] = 3254779904LL;
  v6[2] = __GCDWebServerFormatRFC822_block_invoke;
