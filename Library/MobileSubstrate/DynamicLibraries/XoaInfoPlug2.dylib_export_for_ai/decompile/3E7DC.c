/*
 * func-name: -[GCDAsyncReadPacket readLengthForTermWithPreBuffer:found:]
 * func-address: 0x3e7dc
 * export-type: decompile
 * callers: none
 * callees: 0x516ac, 0x51a24, 0x51a30, 0x51af0, 0x51b08, 0x51b14, 0x51b38
 */

unsigned __int64 __cdecl -[GCDAsyncReadPacket readLengthForTermWithPreBuffer:found:](
        ...
        bool *a4)
{
  ...
  if ( (unsigned __int64)v9 + bytesDone < v8 )
    goto LABEL_29;
  v35 = a4;
  v36 = &v31;
  maxLength = self->maxLength;
  v13 = (id)(maxLength - bytesDone);
  if ( v9 < v13 )
    v13 = v9;
  if ( maxLength )
  ...
  v17 = self->bytesDone;
  v33 = "readBuffer";
  v18 = (char *)objc_msgSend(v7, "readBuffer");
  v19 = v10 - v8 + v14;
  v20 = v19 + 1;
  if ( v19 != -1 )
  {
