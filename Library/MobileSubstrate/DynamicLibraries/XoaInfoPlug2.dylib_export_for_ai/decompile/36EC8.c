/*
 * func-name: -[GCDWebServer addHandlerForMethod:path:requestClass:processBlock:]
 * func-address: 0x36ec8
 * export-type: decompile
 * callers: none
 * callees: 0x36ff4, 0x51af0, 0x51b08, 0x51b14
 */
        ...
        id a6)
{
  ...
  v11[1] = 3254779904LL;
  v11[2] = __77__GCDWebServer_Handlers__addHandlerForMethod_path_requestClass_processBlock___block_invoke;
  ...
  -[GCDWebServer addHandlerForMethod:path:requestClass:asyncProcessBlock:](
    self,
    "addHandlerForMethod:path:requestClass:asyncProcessBlock:",
    a3,
    a4,
    a5,
    v11);
