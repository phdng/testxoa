/*
 * func-name: -[GCDAsyncSocket isDisconnected]
 * func-address: 0x461e4
 * export-type: decompile
 * callers: 0x41ed4, 0x42154
 * callees: 0x51670, 0x517a8, 0x51880, 0x51b08, 0x51b44
 */

bool __cdecl -[GCDAsyncSocket isDisconnected](GCDAsyncSocket *self, SEL a2)
{
  _QWORD *v3; // x20
  char v4; // w19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __32__GCDAsyncSocket_isDisconnected__block_invoke;
