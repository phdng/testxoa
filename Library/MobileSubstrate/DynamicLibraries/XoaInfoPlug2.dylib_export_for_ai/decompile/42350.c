/*
 * func-name: -[GCDAsyncSocket connectToHost:onPort:viaInterface:withTimeout:error:]
 * func-address: 0x42350
 * export-type: decompile
 * callers: 0x4233c
 * callees: 0x51670, 0x517a8, 0x51880, 0x51af0, 0x51b08, 0x51b14, 0x51b20, 0x51b44
 */

bool __cdecl -[GCDAsyncSocket connectToHost:onPort:viaInterface:withTimeout:error:](
        GCDAsyncSocket *self,
        SEL a2,
        id a3,
        unsigned __int16 a4,
        ...
        id *a7)
{
  ...
  GCDAsyncSocket *v23; // [xsp+28h] [xbp-E8h]
  ...
  v21[1] = 3254779904LL;
  v21[2] = __70__GCDAsyncSocket_connectToHost_onPort_viaInterface_withTimeout_error___block_invoke;
