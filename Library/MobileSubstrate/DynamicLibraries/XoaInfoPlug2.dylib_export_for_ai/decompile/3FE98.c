/*
 * func-name: -[GCDAsyncSocket isIPv4Enabled]
 * func-address: 0x3fe98
 * export-type: decompile
 * callers: none
 * callees: 0x51670, 0x517a8, 0x51880
 */

bool __cdecl -[GCDAsyncSocket isIPv4Enabled](GCDAsyncSocket *self, SEL a2)
{
  bool v3; // w19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __31__GCDAsyncSocket_isIPv4Enabled__block_invoke;
