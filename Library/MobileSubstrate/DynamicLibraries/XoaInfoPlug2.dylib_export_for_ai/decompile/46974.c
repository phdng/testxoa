/*
 * func-name: -[GCDAsyncSocket localPort]
 * func-address: 0x46974
 * export-type: decompile
 * callers: none
 * callees: 0x51670, 0x517a8, 0x51880
 */

unsigned __int16 __cdecl -[GCDAsyncSocket localPort](GCDAsyncSocket *self, SEL a2)
{
  ...
  if ( !dispatch_get_specific(self->IsOnSocketQueueOrTargetQueueKey) )
  {
    ...
    v6[1] = 3254779904LL;
    v6[2] = __27__GCDAsyncSocket_localPort__block_invoke;
