/*
 * func-name: -[GCDAsyncSocket writeTimeoutError]
 * func-address: 0x45ea4
 * export-type: decompile
 * callers: none
 * callees: 0x516ac, 0x51af0, 0x51b08, 0x51b38
 */

id __cdecl -[GCDAsyncSocket writeTimeoutError](GCDAsyncSocket *self, SEL a2)
{
  NSBundle *v2; // x19
  NSString *v3; // x20
  NSDictionary *v4; // x21
  ...
  v3 = objc_retainAutoreleasedReturnValue(
         -[NSBundle localizedStringForKey:value:table:](
           ...
           CFSTR("GCDAsyncSocketWriteTimeoutError"),
           CFSTR("Write operation timed out"),
