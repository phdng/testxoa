/*
 * func-name: -[GCDAsyncSocket setupReadTimerWithTimeout:]
 * func-address: 0x49e34
 * export-type: decompile
 * callers: 0x487e4
 * callees: 0x51820, 0x51838, 0x5185c, 0x51868, 0x5188c, 0x51a9c, 0x51aa8, 0x51ad8, 0x51b08
 */

void __cdecl -[GCDAsyncSocket setupReadTimerWithTimeout:](GCDAsyncSocket *self, SEL a2, double a3)
{
  void *v3; // x29
  void *v4; // x30
  void *v5; // d8
  ...
  OS_dispatch_source *readTimer; // x8
  NSObject *v11; // x20
  ...
  if ( a3 >= 0.0 )
  {
    ...
    self->readTimer = v9;
    objc_release(readTimer);
    objc_initWeak(location, self);
    v11 = (NSObject *)self->readTimer;
    v13[0] = _NSConcreteStackBlock;
    v13[1] = 3254779904LL;
    v13[2] = __44__GCDAsyncSocket_setupReadTimerWithTimeout___block_invoke;
