/*
 * func-name: ___30-[GCDAsyncSocket localAddress]_block_invoke
 * func-address: 0x473f0
 * export-type: decompile
 * callers: 0x472f4
 * callees: 0x516ac, 0x51988, 0x51a54, 0x51af0, 0x51b08
 */

void __fastcall __30__GCDAsyncSocket_localAddress__block_invoke(__int64 a1)
{
  __int64 v2; // x8
  int v3; // w0
  id v4; // x0
