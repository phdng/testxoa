/*
 * func-name: +[DeviceInfoHelper bluetoothMACAddress]
 * func-address: 0x1eed8
 * export-type: decompile
 * callers: none
 * callees: 0x51238, 0x518b0, 0x518bc, 0x518c8, 0x51a84, 0x51af0, 0x51b08, 0x51b14, 0x51b38
 */

id __cdecl +[DeviceInfoHelper bluetoothMACAddress](id a1, SEL a2)
{
  void *v4; // x19
  ...
  v6 = (void *)v5(CFSTR("BluetoothAddress"));
  v7 = objc_retain(v6);
  CFRelease(v7);
  dlclose(v4);
