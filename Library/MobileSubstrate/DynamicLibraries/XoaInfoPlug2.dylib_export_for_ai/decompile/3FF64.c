/*
 * func-name: -[GCDAsyncSocket setIPv4Enabled:]
 * func-address: 0x3ff64
 * export-type: decompile
 * callers: none
 * callees: 0x5176c, 0x517a8, 0x51b08, 0x51b44
 */

void __cdecl -[GCDAsyncSocket setIPv4Enabled:](GCDAsyncSocket *self, SEL a2, bool a3)
{
  _QWORD *v4; // x20
  ...
  v5[1] = 3254779904LL;
  v5[2] = __33__GCDAsyncSocket_setIPv4Enabled___block_invoke;
