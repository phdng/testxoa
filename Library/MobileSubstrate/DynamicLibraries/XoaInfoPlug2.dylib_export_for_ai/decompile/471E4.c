/*
 * func-name: ___34-[GCDAsyncSocket connectedAddress]_block_invoke
 * func-address: 0x471e4
 * export-type: decompile
 * callers: 0x470e8
 * callees: 0x516ac, 0x5197c, 0x51a54, 0x51af0, 0x51b08
 */

void __fastcall __34__GCDAsyncSocket_connectedAddress__block_invoke(__int64 a1)
{
  __int64 v2; // x8
  int v3; // w0
  id v4; // x0
