/*
 * func-name: -[OTRAppObject removeFakeItemWithBundleIdentifier:]
 * func-address: 0x6e20
...
void __cdecl -[OTRAppObject removeFakeItemWithBundleIdentifier:](OTRAppObject *self, SEL a2, id a3)
{
  id v5; // x22
  ...
  if ( v6 )
  {
    v6 = +[NSMutableDictionary dictionaryWithDictionary:](
           ...
           v6);
    -[NSMutableDictionary removeObjectForKey:](v6, "removeObjectForKey:", CFSTR("la"));
    -[NSMutableDictionary removeObjectForKey:](v6, "removeObjectForKey:", CFSTR("lo"));
  }
