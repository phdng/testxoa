/*
 * func-name: ___60-[z7c0GPfd connectToHost:onPort:x6EmkMT2:withTimeout:error:]_block_invoke_2
 * func-address: 0x25488
 * export-type: decompile
 * callers: 0x2529c
 * callees: 0x227894, 0x2279b4, 0x227d44, 0x227d50, 0x227d98, 0x227dd4, 0x227de0, 0x227df8, 0x227e04, 0x227e28
 */

void __fastcall __60__z7c0GPfd_connectToHost_onPort_x6EmkMT2_withTimeout_error___block_invoke_2(__int64 a1)
{
  void *v2; // x20
  id v3; // x0
  __int64 v4; // x2
  ...
  v41 = nullptr;
  v6 = objc_retainAutoreleasedReturnValue(objc_msgSend(v3, "b7T17Gd9:port:error:", v4, v5, &v41));
  v7 = objc_retain(v41);
  v8 = a1;
  ...
  if ( v7 )
  {
    ...
    block[2] = __60__z7c0GPfd_connectToHost_onPort_x6EmkMT2_withTimeout_error___block_invoke_3;
  ...
  do
  {
    for ( i = nullptr; i != v15; i = (char *)i + 1 )
    {
      ...
      if ( !v16 && ((unsigned int)objc_msgSend(objc_msgSend(*(id *)(v8 + 32), "class"), "x1zux5fO:", v20) & 1) != 0 )
      {
        v16 = v20;
LABEL_15:
        v21 = objc_retain(v20);
      ...
      if ( v17 )
        continue;
      if ( (unsigned int)objc_msgSend(objc_msgSend(*(id *)(v8 + 32), "class"), "r99mdZDZ:", v20) )
      {
        v17 = v20;
        goto LABEL_15;
      }
...
LABEL_21:
  ...
  v28[1] = 3254779904LL;
  v28[2] = __60__z7c0GPfd_connectToHost_onPort_x6EmkMT2_withTimeout_error___block_invoke_4;
