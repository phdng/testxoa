/*
 * func-name: ___32-[z7c0GPfd x8GKXSEj:port:error:]_block_invoke.154
 * func-address: 0x238a4
 * export-type: decompile
 * callers: 0x2349c
 * callees: 0x227990, 0x227a08, 0x227a44, 0x227a5c, 0x227a68, 0x227d44, 0x227d50, 0x227d80, 0x227d8c, 0x227dc8, 0x227dd4, 0x227de0, 0x227df8, 0x227e04, 0x227e10, 0x227e28
 */

void __fastcall __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_154(__int64 a1)
{
  void *v2; // x19
  id WeakRetained; // x21
  __int64 v4; // x0
  ...
  if ( !WeakRetained )
  {
    v6 = objc_msgSend((id)v4, "w60LGdoh:", CFSTR("Attempting to accept without a delegate. Set a delegate first."));
    goto LABEL_12;
  }
  if ( !*(_QWORD *)(v4 + 24) )
  {
  ...
  if ( (v5 & 1) == 0 || (v5 & 2) == 0 )
  {
    ...
    objc_msgSend(
      *(id *)(a1 + 32),
      "y4UN4goI:c85xGSfj:b8myoukR:port:",
      v55,
      &v54,
      *(_QWORD *)(a1 + 40),
    ...
    if ( (v5 & 1) == 0 && v9 != 0 )
    {
      *(_DWORD *)(*(_QWORD *)(a1 + 32) + 32LL) = (*(__int64 (**)(void))(*(_QWORD *)(a1 + 48) + 16LL))();
      ...
      if ( !v20 )
        goto LABEL_30;
      if ( !*(_WORD *)(a1 + 72) )
        *((_WORD *)objc_msgSend(objc_retainAutorelease(v11), "mutableBytes") + 1) = __rev16((unsigned int)objc_msgSend(*(id *)(a1 + 32), "u07TT340"));
    }
...
LABEL_30:
    ...
    *(_QWORD *)(v23 + 96) = v22;
    ...
    handler[2] = __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_2;
    ...
    v47[1] = 3221225472LL;
    v47[2] = __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_183;
...
LABEL_31:
      ...
      *(_QWORD *)(v32 + 104) = v31;
      ...
      v43[1] = 3254779904LL;
      v43[2] = __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_2_185;
      ...
      v41[1] = 3221225472LL;
      v41[2] = __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_3;
