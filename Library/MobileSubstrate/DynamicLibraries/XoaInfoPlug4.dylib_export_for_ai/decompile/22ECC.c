/*
 * func-name: -[z7c0GPfd setO8VYJOrD:]
 * func-address: 0x22ecc
 * export-type: decompile
 * callers: none
 * callees: 0x2279b4, 0x2279cc, 0x227df8, 0x227e34
 */

void __cdecl -[z7c0GPfd setO8VYJOrD:](z7c0GPfd *self, SEL a2, bool a3)
{
  _QWORD *v4; // x20
  ...
  v5[1] = 3254779904LL;
  v5[2] = __24__z7c0GPfd_setO8VYJOrD___block_invoke;
