/*
 * func-name: -[z7c0GPfd n7JojgqA:error:]
 * func-address: 0x27600
 * export-type: decompile
 * callers: none
 * callees: 0x278f4, 0x2279cc, 0x227de0, 0x227df8, 0x227e04, 0x227e28
 */

void __cdecl -[z7c0GPfd n7JojgqA:error:](z7c0GPfd *self, SEL a2, int a3, id a4)
{
  id v7; // x19
