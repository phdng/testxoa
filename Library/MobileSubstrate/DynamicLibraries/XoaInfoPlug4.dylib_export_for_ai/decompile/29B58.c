/*
 * func-name: -[z7c0GPfd localAddress]
 * func-address: 0x29b58
 * export-type: decompile
 * callers: none
 * callees: 0x22781c, 0x2279cc, 0x227a8c, 0x227df8, 0x227e04, 0x227e34
 */

NSData *__cdecl -[z7c0GPfd localAddress](z7c0GPfd *self, SEL a2)
{
  _QWORD *v3; // x20
  id v4; // x19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __24__z7c0GPfd_localAddress__block_invoke;
