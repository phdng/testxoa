/*
 * func-name: +[z7c0GPfd t5AVChQE:]
 * func-address: 0x303a8
 * export-type: decompile
 * callers: none
 * callees: 0x227570, 0x2275ac, 0x227624, 0x227de0, 0x227df8, 0x227e04, 0x227e28
 */

void __cdecl +[z7c0GPfd t5AVChQE:](id a1, SEL a2, id a3)
{
  _QWORD *v5; // x19
  NSThread *v6; // x22
  __int64 v7; // x23
