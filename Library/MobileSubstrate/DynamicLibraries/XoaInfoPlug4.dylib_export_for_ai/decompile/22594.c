/*
 * func-name: -[z7c0GPfd setDelegate:synchronously:]
 * func-address: 0x22594
 * export-type: decompile
 * callers: none
 * callees: 0x2279b4, 0x2279cc, 0x227a8c, 0x227df8, 0x227e04, 0x227e34
 */

void __cdecl -[z7c0GPfd setDelegate:synchronously:](z7c0GPfd *self, SEL a2, id a3, bool a4)
{
  _BOOL4 v4; // w20
  id v6; // x19
  _QWORD *v7; // x22
  ...
  v9[1] = 3254779904LL;
  v9[2] = __38__z7c0GPfd_setDelegate_synchronously___block_invoke;
