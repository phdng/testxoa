/*
 * func-name: ___32-[z7c0GPfd x8GKXSEj:port:error:]_block_invoke_2
 * func-address: 0x23ddc
 * export-type: decompile
 * callers: 0x238a4
 * callees: 0x227a50, 0x227d50, 0x227dd4, 0x227de0, 0x227df8
 */

void __fastcall __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_2(__int64 a1)
{
  void *v2; // x19
  id WeakRetained; // x21
  uintptr_t data; // x22
