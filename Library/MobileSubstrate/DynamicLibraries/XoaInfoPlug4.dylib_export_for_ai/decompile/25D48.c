/*
 * func-name: -[z7c0GPfd j1MnoJRR:withTimeout:error:]
 * func-address: 0x25d48
 * export-type: decompile
 * callers: none
 * callees: 0x22781c, 0x2279cc, 0x227a8c, 0x227df8, 0x227e04, 0x227e10, 0x227e34
 */

bool __cdecl -[z7c0GPfd j1MnoJRR:withTimeout:error:](z7c0GPfd *self, SEL a2, id a3, double a4, id *a5)
{
  id v8; // x20
  _QWORD *v9; // x22
  int v10; // w8
  ...
  v13[1] = 3254779904LL;
  v13[2] = __39__z7c0GPfd_j1MnoJRR_withTimeout_error___block_invoke;
  ...
  if ( dispatch_get_specific(self->u0jIZ77n) )
    ...
    dispatch_sync((dispatch_queue_t)self->g3BckoJI, v9);
