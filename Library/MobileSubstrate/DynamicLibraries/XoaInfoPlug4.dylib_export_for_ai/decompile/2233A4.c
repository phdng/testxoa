/*
 * func-name: __ZN7tinystl6vectorIP14InterceptEntryNS_9allocatorEE9push_backERKS2_
 * func-address: 0x2233a4
 * export-type: decompile
 * callers: 0x223380
 * callees: 0x227834, 0x227840
 */

void __fastcall tinystl::vector<InterceptEntry *,tinystl::allocator>::push_back(char **a1, char *a2)
{
  char *v2; // x21
