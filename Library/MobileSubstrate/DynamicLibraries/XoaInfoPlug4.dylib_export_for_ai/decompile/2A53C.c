/*
 * func-name: -[z7c0GPfd x06GfTlh:]
 * func-address: 0x2a53c
 * export-type: decompile
 * callers: 0x26e88
 * callees: 0x22781c, 0x227a08, 0x227a44, 0x227a5c, 0x227a68, 0x227d80, 0x227d8c, 0x227dc8, 0x227df8
 */

void __cdecl -[z7c0GPfd x06GfTlh:](z7c0GPfd *self, SEL a2, int a3)
{
  uintptr_t v5; // x21
  OS_dispatch_source *v6; // x0
  OS_dispatch_source *readSource; // x8
  OS_dispatch_source *v8; // x0
  OS_dispatch_source *c2ubGOqj; // x8
  NSObject *v10; // x22
  NSObject *v11; // x23
  NSObject *v12; // x0
  NSObject *v13; // x0
  ...
  v8 = (OS_dispatch_source *)dispatch_source_create(
                               ...
                               0,
                               (dispatch_queue_t)self->g3BckoJI);
  c2ubGOqj = self->c2ubGOqj;
  self->c2ubGOqj = v8;
  objc_release(c2ubGOqj);
  objc_initWeak(&location, self);
  v10 = (NSObject *)self->readSource;
  handler[0] = _NSConcreteStackBlock;
  handler[1] = 3254779904LL;
  handler[2] = __21__z7c0GPfd_x06GfTlh___block_invoke;
  handler[3] = &__block_descriptor_40_e8_32w_e5_v8__0l;
  objc_copyWeak(&v23, &location);
  dispatch_source_set_event_handler(v10, handler);
  v11 = (NSObject *)self->c2ubGOqj;
  v20[0] = _NSConcreteStackBlock;
  v20[1] = 3254779904LL;
  v20[2] = __21__z7c0GPfd_x06GfTlh___block_invoke_2;
  ...
  v16[1] = 3254779904LL;
  v16[2] = __21__z7c0GPfd_x06GfTlh___block_invoke_3;
  v16[3] = &__block_descriptor_44_e8_32r_e5_v8__0l;
  v16[4] = v18;
  v17 = a3;
  dispatch_source_set_cancel_handler(v12, v16);
  v13 = (NSObject *)self->c2ubGOqj;
  v14[0] = _NSConcreteStackBlock;
  v14[1] = 3254779904LL;
  v14[2] = __21__z7c0GPfd_x06GfTlh___block_invoke_441;
