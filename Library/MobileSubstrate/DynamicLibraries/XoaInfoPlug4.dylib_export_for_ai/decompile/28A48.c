/*
 * func-name: -[z7c0GPfd isDisconnected]
 * func-address: 0x28a48
 * export-type: decompile
 * callers: 0x24c10, 0x24e90
 * callees: 0x22781c, 0x2279cc, 0x227a8c, 0x227df8, 0x227e34
 */

bool __cdecl -[z7c0GPfd isDisconnected](z7c0GPfd *self, SEL a2)
{
  _QWORD *v3; // x20
  char v4; // w19
  ...
  v6[1] = 3254779904LL;
  v6[2] = __26__z7c0GPfd_isDisconnected__block_invoke;
