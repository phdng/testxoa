/*
 * func-name: -[z7c0GPfd w4QEGAPR:error:]
 * func-address: 0x23ff8
 * export-type: decompile
 * callers: none
 * callees: 0x22781c, 0x2279cc, 0x227a8c, 0x227df8, 0x227e04, 0x227e10, 0x227e34
 */

bool __cdecl -[z7c0GPfd w4QEGAPR:error:](z7c0GPfd *self, SEL a2, id a3, id *a4)
{
  id v6; // x20
  _QWORD *v7; // x22
  id v8; // x20
  ...
  v19[1] = 3254779904LL;
  v19[2] = __27__z7c0GPfd_w4QEGAPR_error___block_invoke;
  ...
  v14[1] = 3254779904LL;
  v14[2] = __27__z7c0GPfd_w4QEGAPR_error___block_invoke_2;
  ...
  if ( dispatch_get_specific(self->u0jIZ77n) )
    ...
    dispatch_sync((dispatch_queue_t)self->g3BckoJI, v10);
