/*
 * func-name: __ZN7tinystl6vectorIP10RelocLabelNS_9allocatorEE9push_backERKS2_
 * func-address: 0x220bbc
 * export-type: decompile
 * callers: 0x220b94
 * callees: 0x227834, 0x227840
 */

void __fastcall tinystl::vector<RelocLabel *,tinystl::allocator>::push_back(char **a1, char *a2)
{
  char *v2; // x21
