/*
 * func-name: -[z7c0GPfd r1XDdl39:c470PDfY:total:]
 * func-address: 0x2cbcc
 * export-type: decompile
 * callers: none
 * callees: 0x22781c, 0x2279cc, 0x227a8c, 0x227df8, 0x227e34
 */

float __cdecl -[z7c0GPfd r1XDdl39:c470PDfY:total:](
        z7c0GPfd *self,
        SEL a2,
        signed __int64 *a3,
        unsigned __int64 *a4,
        unsigned __int64 *a5)
{
  ...
  v9[1] = 3254779904LL;
  v9[2] = __36__z7c0GPfd_r1XDdl39_c470PDfY_total___block_invoke;
