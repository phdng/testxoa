/*
 * func-name: -[h8p5Rns8 networkStatusForFlags:]
 * func-address: 0x410c4
 * export-type: decompile
 * callers: none
 * callees: 0x2276b4
 */

signed __int64 __cdecl -[h8p5Rns8 networkStatusForFlags:](h8p5Rns8 *self, SEL a2, unsigned int a3)
{
  __int64 v4; // x9
  __int64 v5; // x8
  __int64 v6; // x9
