/*
 * func-name: -[NSData h2RJ4MJj:]
 * func-address: 0x20e3e8
 * export-type: decompile
 * callers: none
 * callees: 0x227d5c, 0x227de0, 0x227e10, 0x227e28
 */

id __cdecl -[NSData h2RJ4MJj:](NSData *self, SEL a2, unsigned int a3)
{
  NSData *v4; // x22
  char *v5; // x20
