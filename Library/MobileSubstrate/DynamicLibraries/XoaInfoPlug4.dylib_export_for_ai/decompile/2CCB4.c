/*
 * func-name: ___36-[z7c0GPfd r1XDdl39:c470PDfY:total:]_block_invoke
 * func-address: 0x2ccb4
 * export-type: decompile
 * callers: 0x2cbcc
 * callees: 0x227de0
 */

unsigned __int64 __fastcall __36__z7c0GPfd_r1XDdl39_c470PDfY_total___block_invoke(unsigned __int64 result)
{
  _QWORD *v1; // x19
  void *v2; // x20
  __int64 v3; // x8
  ...
  if ( v2
    && (result = (unsigned __int64)objc_msgSend(
                                     v2,
                                     "isKindOfClass:",
                                     +[h5YsgJIz class](&OBJC_CLASS___h5YsgJIz, "class")),
        (result & 1) != 0) )
  {
