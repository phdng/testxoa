/*
 * func-name: -[z7c0GPfd p1lW2KkS:]
 * func-address: 0x298e0
 * export-type: decompile
 * callers: 0x291d8, 0x2945c
 * callees: 0x227be8, 0x227de0
 */

unsigned __int16 __cdecl -[z7c0GPfd p1lW2KkS:](z7c0GPfd *self, SEL a2, int a3)
{
