/*
 * func-name: -[z7c0GPfd x8GKXSEj:port:error:]
 * func-address: 0x2349c
 * export-type: decompile
 * callers: 0x23484
 * callees: 0x22781c, 0x2279cc, 0x227a8c, 0x227de0, 0x227df8, 0x227e04, 0x227e10, 0x227e34
 */

bool __cdecl -[z7c0GPfd x8GKXSEj:port:error:](z7c0GPfd *self, SEL a2, id a3, unsigned __int16 a4, id *a5)
{
  id v8; // x19
  id v9; // x21
  _QWORD *v10; // x24
  ...
  v23[1] = 3254779904LL;
  v23[2] = __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke;
  ...
  v17[1] = 3254779904LL;
  v17[2] = __32__z7c0GPfd_x8GKXSEj_port_error___block_invoke_154;
  ...
  if ( dispatch_get_specific(self->u0jIZ77n) )
    ...
    dispatch_sync((dispatch_queue_t)self->g3BckoJI, v13);
