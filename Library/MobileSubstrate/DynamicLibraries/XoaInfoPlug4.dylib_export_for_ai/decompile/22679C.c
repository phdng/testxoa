 ...
 * func-address: 0x22679c
 * export-type: decompile
 * callers: 0x226648, 0x226794
 * callees: 0x227894, 0x227abc, 0x227af8, 0x227b28, 0x227b4c, 0x227b58, 0x227b7c, 0x227b88, 0x227cd8, 0x227f60, 0x227fd8
 */
                                      ...
                                      if ( v23 )
                                      {
                                        ...
                                        if ( v24 == v10() )
                                        {
                                          if ( v27(v23, v28, 32, 134217984) )
                                            sscanf(v28, "%d.%d.%d", &_MergedGlobals_0, &dword_2CD4C4, &dword_2CD4C8);
                                        }
                                      }
                                    }
                                    v26(v20);
