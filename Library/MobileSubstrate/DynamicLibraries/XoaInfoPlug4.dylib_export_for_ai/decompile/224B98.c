/*
 * func-name: __ZN7tinystl6vectorIP11MemoryArenaNS_9allocatorEE9push_backERKS2_
 * func-address: 0x224b98
 * export-type: decompile
 * callers: 0x2216c4, 0x2248d8
 * callees: 0x227834, 0x227840
 */

void __fastcall tinystl::vector<MemoryArena *,tinystl::allocator>::push_back(char **a1, char *a2)
{
  char *v2; // x21
