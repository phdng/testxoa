/*
 * func-name: -[z7c0GPfd b2ZSKiRB:]
 * func-address: 0x276c4
 * export-type: decompile
 * callers: none
 * callees: 0x227a08, 0x227a44, 0x227a68, 0x227a74, 0x227a98, 0x227d80, 0x227d8c, 0x227dc8, 0x227df8
 */

void __cdecl -[z7c0GPfd b2ZSKiRB:](z7c0GPfd *self, SEL a2, double a3)
{
  void *v3; // x29
  void *v4; // x30
  void *v5; // d8
  ...
  OS_dispatch_source *n9JfPN1D; // x8
  NSObject *v11; // x20
  ...
  if ( a3 >= 0.0 )
  {
    ...
    n9JfPN1D = self->n9JfPN1D;
    self->n9JfPN1D = v9;
    objc_release(n9JfPN1D);
    objc_initWeak(location, self);
    v11 = (NSObject *)self->n9JfPN1D;
    v13[0] = _NSConcreteStackBlock;
    v13[1] = 3254779904LL;
    v13[2] = __21__z7c0GPfd_b2ZSKiRB___block_invoke;
    ...
    dispatch_source_set_timer((dispatch_source_t)self->n9JfPN1D, v12, 0xFFFFFFFFFFFFFFFFLL, 0);
    dispatch_resume((dispatch_object_t)self->n9JfPN1D);
